...
//using CBDistro.Services.Security;
//using System;
...
//{
//    public class WebAuthenticationService : CBDistro.Services.IAuthenticationService<int>
//    {
...
//        }
//        public async Task LogInAsyncData(IUserAuthLoginData user, params Claim[] extraClaims)
//        {
//            ClaimsIdentity identity = new ClaimsIdentity(CookieAuthenticationDefaults.AuthenticationScheme
//                                                            , ClaimsIdentity.DefaultNameClaimType
//                                                            , ClaimsIdentity.DefaultRoleClaimType);
...
//        {
//            CBDistro.Models.Domain.UserBase baseUser = null;
...
//        {
//            CBDistro.Models.Domain.UserBase baseUser = new UserBase();
